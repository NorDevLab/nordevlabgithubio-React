    ...
    <div className="home1-container">
      ...
      <div className="home1-container1 back">
          ...
          <div data-thq="thq-mobile-menu" className="home1-mobile-menu">
            <div className="home1-nav">
              ...
              <nav className="home1-links">
                ...
                <span className="home1-text01">Features</span>
                <span className="home1-text02">Pricing</span>
                <span className="home1-text03">Team</span>
                <span className="home1-text04">Blog</span>
              </nav>
        ...
        <div className="home1-container3">
          <div id="tblock" className="home1-container4">
            <Link to="/about" className="home1-text05">
              ABOUT
            </Link>
            <span className="home1-text06">CONTACT US</span>
            <span className="home1-text07">SERVICES</span>
          </div>
          <div id="text_to_hide" className="home1-container5">
