      ...
      >
        ...
        >
          <nav className="navbar-interactive-links">
            ...
            <span className="navbar-interactive-text01">{props.text2}</span>
            <span className="navbar-interactive-text02">{props.text3}</span>
            <span className="navbar-interactive-text03">{props.text4}</span>
            <span className="navbar-interactive-text04">{props.text5}</span>
          </nav>
        ...
        >
          <div className="navbar-interactive-nav">
            ...
            <nav className="navbar-interactive-links1">
              <Link to="/about" className="navbar-interactive-navlink">
                {props.text6}
              </Link>
              <span className="navbar-interactive-text05">{props.text7}</span>
              <span className="navbar-interactive-text06">{props.text8}</span>
              <span className="navbar-interactive-text07">{props.text9}</span>
              <span className="navbar-interactive-text08">{props.text10}</span>
            </nav>
            <div className="navbar-interactive-buttons1"></div>
          </div>
